defmodule Factory.Completion.Complete do
...
defmodule Factory.Completion.Failed do
...
defmodule Factory.Completion.Continue do
...
defmodule Factory.IterationResult do
  ...
  @type completion :: Factory.Completion.Complete.t() | Factory.Completion.Failed.t() | nil
...
defmodule Factory.RunResult do
  ...
  @type completion ::
          Factory.Completion.Complete.t()
          | Factory.Completion.Failed.t()
          | Factory.Completion.Continue.t()

  @type t :: %__MODULE__{
          iterations: [Factory.IterationResult.t()],
          completion: completion(),
...
defmodule Factory.PausedTask do
