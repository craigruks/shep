defmodule Factory.PromptBuilder do
  ...
  @spec build(Factory.Task.t()) :: {String.t(), non_neg_integer()}
  def build(%Factory.Task{} = task) do
  ...
  @doc false
  def prompts_dir do
    Application.app_dir(:factory, "priv/prompts")
  end
