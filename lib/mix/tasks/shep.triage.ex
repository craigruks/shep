defmodule Mix.Tasks.Shep.Triage do
  @shortdoc "Generate a triage checklist from recent Shep completions."
  ...
  defp print_checklist(issues, _repo) do
    ...
    Mix.shell().info("\nRun `just shep-promote` when ready.")
  end
