defmodule Mix.Tasks.Factory.List do
  @shortdoc "List available templates and current orchestrator state."
  @moduledoc "Show factory templates, running tasks, and queued candidates."
  ...
  defp print_templates do
    templates = Factory.PromptBuilder.list_templates()
    Mix.shell().info("\nTemplates:")
  ...
  defp print_state do
    state = Factory.Orchestrator.snapshot()
